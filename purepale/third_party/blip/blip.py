...
from purepale.third_party.blip.med import BertConfig, BertLMHeadModel, BertModel
from purepale.third_party.blip.vit import VisionTransformer, interpolate_pos_embed
